...
export const COMMANDS: CommandDef[] = [
  ...
  { path: ['inbox', 'reply'], summary: 'Send reply (send scope; preview + typed-confirm unless --yes)',
    positional: ['site', { name: 'thread-id', type: 'number' }],
    flags: ['--body', '--body-file', '--template', '--body-html', '--body-html-file', { name: '--attach', type: 'string[]' }, { name: '--quote', type: 'bool' }, { name: '--yes', type: 'bool' }, '--idempotency-key'],
  ...
  { path: ['inbox', 'send'], summary: 'Send a new email - creates a fresh thread (send scope)',
    positional: ['site'],
    flags: ['--to', '--cc', '--subject', '--from', '--body', '--body-file', '--template', '--body-html', '--body-html-file', { name: '--attach', type: 'string[]' }, { name: '--yes', type: 'bool' }, '--output', '--idempotency-key'],
