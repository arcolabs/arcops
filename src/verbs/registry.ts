...
export const VERBS: VerbDef[] = [
  ...
  },
  {
    ...
    args: [
      ...
      { name: 'body_html', cliName: 'body-html', type: 'string', description: 'Optional HTML body part; combined with the text body as multipart/alternative.' },
      { name: 'body_html_file', cliName: 'body-html-file', type: 'string', description: 'Path to a file containing the HTML body (- for stdin).' },
  ...
  },
  {
    ...
    http: { method: 'POST', path: '/api/sites/:siteId/inbox/send', body: ['to', 'cc', 'subject', 'body', 'from', 'bodyHtml'] },
    outputShape: 'unknown',
  },
